  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered table-striped" >
        ...
        <thead>
          <tr>
            <th  style="color: aliceblue">admin_id</th>
            <th  style="color: aliceblue">user_id</th>
            <th  style="color: aliceblue">Product_name</th>
            <th  style="color: aliceblue">Product_type</th>
            <th  style="color: aliceblue">Product_Price</th>
            <th  style="color: aliceblue">Product_image</th>
